...
function ValGrue({ trails, routes }: { trails: Trail[]; routes: Routes }) {
  return (
    <div className="pt-3 container">
      ...
      <header className="text-center my-8">
        <h1 className="px-5 py-1 mb-0 text-2xl md:text-3xl font-bold text-center text-forest-green-700">Val Grue</h1>
      </header>
      <section>
              ...
              return (
                <div className="border rounded-lg sentieri-aumentati-card bg-white shadow-lg">
                  <div className="md:col-span-3">
                    <MapBlock trails={[trail]} routes={routes} lat={lat} lng={lng} category="Val Grue" classes="m-0" legend={false} />
                  </div>
